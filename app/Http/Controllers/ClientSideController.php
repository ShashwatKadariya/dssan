...
class ClientSideController extends Controller
{
    ...
    public function alumni($slug)
    {
        ...
        $alumni = Alumni::where("batch_id", $batch->id)
    ...
    {
        $events = Event::orderBy("event_date_time", "desc")
            ->take(3)
            ->get();
        $news = News::orderBy("release_date", "desc")
            ->take(3)
            ->get();
    ...
    public function article($slug)
    {
        ...
        $latest_news = News::orderBy("release_date", "desc")
            ->take(3)
            ->get();
