    ...
    <section class="w-11/12 mx-auto mt-16 mb-8 lg:mb-16">
        ...
        <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16 ">
            @foreach ($galleries as $gallery)
                <a href="{{ route('photoGallery.show', $gallery->slug) }}" target="blank">
                    <div data-aos="fade-up" data-aos-duration="800" class="relative  drop-shadow-sm">
                        <div class="mx-auto aspect-3/2">
                            <img src=" {{url(asset('/storage/' . $gallery->cover_image))}}" alt="" class="">
                        </div>
