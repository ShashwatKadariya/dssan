...
@section('content')
    <div class="p-4">
        ...
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="w-2/4 m-auto"
            id="submitForm">
            @csrf
            <p class="mb-6">Add Events</p>
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="event_title" class="form-input peer" placeholder=" " required
            ...
            <div class="relative z-0 w-full mb-6 group">
                <label class="text-gray-500 text-sm">Upload Event Banner</label>
