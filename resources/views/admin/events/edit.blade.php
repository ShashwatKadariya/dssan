...
@section('content')
    <div class="p-4">
        <a class="back-btn" href="{{ route('events.index') }}">Back</a>
        <form action="{{ route('events.update', $event->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="event_title" class="form-input peer" placeholder=" "
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="date" name="event_date" class="form-input peer" placeholder=" "
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="time" name="event_time" class="form-input peer" placeholder=" "
            ...
            <div class="relative z-0 w-full mb-6 group">
                <label class="text-gray-500 text-sm">Edit Banner</label>
                ...
                <img id="oldImage" src="{{ asset('/storage/' . $event->image) }}" class="block p-2 max-h-20"
                    alt="team">
            </div>
