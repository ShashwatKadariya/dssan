...
@section('content')
    <div class="p-4">
        ...
        <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data" class="w-2/4 m-auto"
            id="submitForm">
            @csrf
            <p class="mb-6">Add News</p>
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="headline" class="form-input peer" placeholder=" " required
                    value="{{ old('headline') }}">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="tagline" class="form-input peer" placeholder=" " required
                    value="{{ old('tagline') }}">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="reported_by" class="form-input peer" placeholder=" " required
            ...
            <div class="relative z-0 w-full mb-6 group">
                ...
                <input type="date" name="release_date" class="form-input peer" placeholder=" " required
            ...
            <div class="relative z-0 w-full mb-6 group">
                <label class="text-gray-500 text-sm">Upload News Banner</label>
