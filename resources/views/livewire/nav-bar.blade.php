<header class="sticky top-0 z-10 bg-white dark:bg-black">
    ...
    <section id="mobile-menu"
        class="absolute top-11 my-2 sm:top-12 bg-slate-50 dark:bg-zinc-800 sm:hidden w-full hidden flex-col origin-top animate-open-menu">
        <nav class="flex flex-col px-5 pb-1" aria-label="mobile">
            ...
            <a href="/about" class="py-2 hover:text-very-deep-orange border-b border-very-deep-orange">About</a>
