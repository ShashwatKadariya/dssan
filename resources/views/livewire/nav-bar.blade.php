<header class="fixed w-full top-0 z-10 bg-white">
    <section class="mx-auto w-11/12 py-2.5 flex justify-between items-center">
        <a href="/home">
            <img src="{{ asset('images/logo/dssanblue.png') }}" alt="dssanlogo"
                class="max-w-[12rem]">
        </a>
        {{-- big screens navbar --}}
        <div>
    ...
    <section id="mobile-menu"
        class="absolute top-12 bg-ui-white backdrop-filter backdrop-blur-lg bg-opacity-80 sm:hidden w-full hidden flex-col origin-top animate-open-menu">
